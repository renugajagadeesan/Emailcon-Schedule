...
const ListPage = ({ onClose }) => {
  ...
  const handleSaveStudent = () => {
    if (
      editFormData.Fname.trim() &&
      editFormData.Lname.trim() &&
      editFormData.Email.trim() &&
      editFormData.Coursename.trim() &&
      editFormData.Coursetype.trim() &&
      editFormData.Date.trim() &&
      editFormData.group
    ) {
      setShowEditingToast(true); // Show toast
      axios
        .put(`${apiConfig.baseURL}/api/stud/students/${editingStudent._id}`, {
